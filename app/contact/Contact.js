...
const Contact = () => {
  const [state, handleSubmit] = useForm("ddsad");
        ...
        <div className="container px-6 py-12 mx-auto">
          <div>
            ...
            <p className="mt-3 text-gray-500 -400">
              We would love to hear from you. Please fill out this form or shoot us
              an email.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
              <div>
                ...
                <p className="mt-2 text-sm text-gray-500">Kerlossony@gmail.com</p>
                <p className="mt-2 text-sm text-gray-500">Meray.ashraf@msa.edu.eg</p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-gray-500">EL Nozha, Cairo, Egypt</p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-gray-500">+20 1019085973</p>
              </div>
            </div>
