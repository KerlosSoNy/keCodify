...
export default function Header(){
  ...
  return (
    <div className="w-full relative">
          ...
          <div className="hidden lg:flex flex-row items-center justify-end w-fit gap-8 font-bold">
          <Link href="/category">
            Languages Category
          </Link>
          <Link href="/ourTeam">
          ...
          <button   className="cursor-pointer block lg:hidden" onClick={() => setIsOpen(!isOpen)}>
              <RiMenu3Line
                    size={30}
                    color="black"
                />
